Design MinMax Queue
Difficulty: MediumAccuracy: 83.06%Submissions: 2K+Points: 4
...
class SpecialQueue 
{
    ...
    public PriorityQueue<Integer> maxi;
    public PriorityQueue<Integer> mini;
    public SpecialQueue() 
    {
        this.q=new LinkedList();
        this.mini=new PriorityQueue<>();
        this.maxi=new PriorityQueue<>(Collections.reverseOrder());
    }
